...
0.46 against 0.85) and not better: capacity is not what is missing at this rung. Next rungs
in order: Pegasus 2 and Zephyr 1 fragments at the same variable counts (running), then the
230-channel contextual actor on the same sets (gate 3), then wall-clock and size, then
quality.
