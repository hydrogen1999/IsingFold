...
Best configuration at this rung: linear actor on the 230 channels, leave-one-out baseline.
Two contextual runs at lr 3e-3 separate collapse-by-rate from collapse-by-architecture.
