...
(`results/curriculum/{P,Z}_linear_s*.log`, 200 iterations, horizon 160, 120 s episodes):
    ...
    Pegasus 3, 0        0.76 (it 150)            0.63 (it 150)               running
