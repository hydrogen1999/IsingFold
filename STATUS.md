...
variables on cycles with pendant dead ends and a chord (`results/curriculum/a_linear_s*.log`):
    ...
    1       0.35 -> 0.90 (it 140)    0.41 -> 0.95 (it 140)       running
