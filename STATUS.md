...
(`goose:~/prj_IsingFold_pr2/runs/curriculum/ink24_{pegasus16,zephyr15}_prefixinit_s0.log`):
    ...
    Pegasus 16    0.10  /  0.25  /  0.85                     15 / 24 at prefix 0.45
    Zephyr 15     0.35  /  0.60  /  running                  21 / 24 at prefix 0.55
...
iterations while its assistance falls from 0.9 to 0.45 of the witness (`results/hardware/`).
